...
Продуктовые решения PO в `FEATURE_MAP.md` («Seller AI-first model») сильнее brief, ревизии и макета: если кадр
противоречит более позднему решению (например, обязательное фото), действует решение, а расхождение записывается в
README принятой копии макета.
