...
async function prepare() {
  ...
  try {
    ...
    const expected = ['auth_otp_challenges', 'auth_sessions', 'buyer_interests', 'locations', 'offer_comment_translations', 'offer_photos', 'offers', 'photos', 'product_aliases', 'product_localized_names', 'products', 'seller_change_item_photos', 'seller_change_items', 'seller_change_sets', 'sellers', 'users'];
